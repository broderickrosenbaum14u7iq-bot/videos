<?php
/**
 * "Homepage Ads" tab — see screen.php for why every tab's fields render every time.
 *
 * @package Tube_Ads
 *
...
foreach ([Placement::HomepageTop, Placement::HomepageBetweenSections] as $tube_ads_placement) {
