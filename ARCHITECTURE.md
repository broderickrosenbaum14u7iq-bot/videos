...
- **`declare(strict_types=1);`** as the first statement in every PHP file across every plugin (nine as of ADR-0002/0003/0004, 2026-08-28 — see `ARCHITECTURE_FREEZE.md` Frozen Decision #1) and the theme — no loose type coercion anywhere in this codebase.
